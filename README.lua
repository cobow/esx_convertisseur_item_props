...
# c'est un projet en cours car je suit pas satisfait manque quelque correction par exemple l'item transformer en props et visible mais c'est pas un props libre si vous voyez ceux que je veut dire 
